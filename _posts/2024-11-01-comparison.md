...
To get a better idea of the actual size and weight required we compared several off-the-shelf panels and put the data together in a spreadsheet (You can see the full sheet in the Reference section below):
